					...
					<div class="card-body">
						...
						<form action="order" method="post">
							...
							<div class="form-row">
									...
									<label for="inputEmail4">Tender Name</label> <input type="text"
										class="form-control" id="inputEmail4"
										value="<%=c.getCname()%>" readonly="readonly" name="tname">
								</div>
										<%
										}
										%>
...
document.getElementById("paymentMode").addEventListener("change", function() {
    ...
    var selectedPrice = selectedOption.getAttribute("price");
