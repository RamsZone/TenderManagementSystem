 ...
 * Generated at: 2024-03-03 08:09:40 UTC
...
public final class checkout_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<h3 class=\"text-center text-success\">Your selected bid</h3>\n");
      ...
      out.write("</a></td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(c.getCtype());
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(c.getClocation());
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(c.getCprice());
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(c.getCdeadline());
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(c.getCdesc());
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><a\n");
      out.write("\t\t\t\t\t\t\t\t\t\thref=\"remove_utender?tid=");
      out.print(c.getTid());
      out.write("&&uid=");
      out.print(c.getUid());
      out.write("&&cid=");
      out.print(c.getCid());
      out.write("\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"btn btn-danger btn-sm\">Remove</a></td>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"paymentMode\">Tender</label> <select\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"paymentMode\" name=\"tname\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"noselect\" selected hidden>Select an option</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\n");
      out.write("\t<script>\n");
      out.write("document.getElementById(\"paymentMode\").addEventListener(\"change\", function() { //changes in dropdown\n");
      out.write("    var selectedOption = this.options[this.selectedIndex]; //selecvted option retrivval\n");
      out.write("    var selectedPrice = selectedOption.getAttribute(\"price\"); //price value of selected option\n");
