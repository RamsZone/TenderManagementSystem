 ...
 * Generated at: 2024-02-18 09:01:31 UTC
...
public final class aboutus_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/all_component/navbar.jsp", Long.valueOf(1708246086000L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>ABOUT US: Index</title>\n");
      ...
      out.write("\t\n");
      out.write("\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t<h2>Welcome to Our Tender Management System</h2>\n");
      out.write("\t\t\t\t\t\t<p>Our Tender Management System is a comprehensive platform\n");
      out.write("\t\t\t\t\t\t\tdesigned to simplify the tendering process for both companies and\n");
      out.write("\t\t\t\t\t\t\tvendors. Whether you're a company seeking goods or services or a\n");
      out.write("\t\t\t\t\t\t\tvendor looking to bid on opportunities, our system provides the\n");
      out.write("\t\t\t\t\t\t\ttools and features you need to streamline the entire process.</p>\n");
      out.write("\t\t\t\t\t\t<h3>For Companies</h3>\n");
      out.write("\t\t\t\t\t\t<p>Company administrators have full control over the tendering\n");
      out.write("\t\t\t\t\t\t\tprocess. They can create new tenders, edit existing ones, and\n");
      out.write("\t\t\t\t\t\t\tdelete outdated ones. Our intuitive interface makes it easy to\n");
      out.write("\t\t\t\t\t\t\tspecify requirements, set deadlines, and provide detailed\n");
      out.write("\t\t\t\t\t\t\tdescriptions of the goods or services required.</p>\n");
      out.write("\t\t\t\t\t\t<p>Once tenders are published, companies can review bids\n");
      out.write("\t\t\t\t\t\t\tsubmitted by vendors. Our system provides advanced filtering and\n");
      out.write("\t\t\t\t\t\t\tsorting options to help companies evaluate bids based on various\n");
      out.write("\t\t\t\t\t\t\tcriteria such as price, quality, and vendor reputation.</p>\n");
      out.write("\t\t\t\t\t\t<p>Company administrators can also communicate with vendors\n");
      out.write("\t\t\t\t\t\t\tdirectly through our platform, providing clarification on tender\n");
      out.write("\t\t\t\t\t\t\trequirements or requesting additional information as needed.</p>\n");
      out.write("\t\t\t\t\t\t<h3>For Vendors</h3>\n");
      out.write("\t\t\t\t\t\t<p>Vendors can register on our platform to gain access to a\n");
      out.write("\t\t\t\t\t\t\twide range of tender opportunities. Our system allows vendors to\n");
      out.write("\t\t\t\t\t\t\tsearch for tenders based on their area of expertise, location, or\n");
      out.write("\t\t\t\t\t\t\tother relevant criteria.</p>\n");
      out.write("\t\t\t\t\t\t<p>Once registered, vendors can submit bids for available\n");
      out.write("\t\t\t\t\t\t\ttenders directly through our platform. Our user-friendly\n");
      out.write("\t\t\t\t\t\t\tinterface makes it easy to upload proposal documents, specify\n");
      out.write("\t\t\t\t\t\t\tpricing details, and communicate with company administrators.</p>\n");
      out.write("\t\t\t\t\t\t<p>Vendors can track the status of their bids in real-time and\n");
      out.write("\t\t\t\t\t\t\treceive notifications when their bids are accepted or rejected.\n");
      out.write("\t\t\t\t\t\t\tThis transparency helps vendors manage their resources more\n");
      out.write("\t\t\t\t\t\t\teffectively and focus their efforts on opportunities with the\n");
      out.write("\t\t\t\t\t\t\thighest likelihood of success.</p>\n");
      out.write("\t\t\t\t\t\t<h3>Our Mission</h3>\n");
      out.write("\t\t\t\t\t\t<p>Our mission is to revolutionize the tendering process by\n");
      out.write("\t\t\t\t\t\t\tproviding an efficient, transparent, and user-friendly platform\n");
      out.write("\t\t\t\t\t\t\tfor companies and vendors alike. We believe that by simplifying\n");
      out.write("\t\t\t\t\t\t\tthe tendering process, we can help organizations save time,\n");
      out.write("\t\t\t\t\t\t\treduce costs, and make better-informed decisions.</p>\n");
      out.write("\t\t\t\t\t\t<p>Thank you for choosing our Tender Management System. We\n");
      out.write("\t\t\t\t\t\t\tlook forward to serving you and helping you achieve your\n");
      out.write("\t\t\t\t\t\t\ttendering goals.</p>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</div>\n");
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /all_component/navbar.jsp(88,3) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
